...
two of the stops since more people died from tornadoes than were injured by the 
...
```{r}
ggplot(top.hd, aes(x=EVTYPE, y=value,fill=variable)) + geom_bar(stat='identity') + labs(x="Storm Type", y="People injured and killed")
